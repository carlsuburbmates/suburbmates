    ...
    palettes: [
      {
        ...
        heroSurface: 'bg-white/10 border-white/20',
        heroAction: 'bg-white text-slate-950 hover:bg-slate-100',
        heroSecondary: 'bg-white/10 text-white border-white/20 hover:bg-white/20',
      ...
      },
      {
        ...
        heroBg: 'bg-zinc-50',
        heroText: 'text-zinc-900',
        heroMutedText: 'text-zinc-700',
        heroSurface: 'bg-white border-zinc-300',
        heroAction: 'bg-zinc-900 text-white hover:bg-zinc-800',
        heroSecondary: 'bg-white text-zinc-900 border-zinc-300 hover:bg-zinc-100',
      ...
      },
      {
        ...
        heroBg: 'bg-[#1C1A18]',
        heroText: 'text-white',
        heroMutedText: 'text-[#F2EFEA]',
        heroSurface: 'bg-white/10 border-white/20',
        heroAction: 'bg-white text-[#1C1A18] hover:bg-[#F2EFEA]',
        heroSecondary: 'bg-white/10 text-white border-white/20 hover:bg-white/20',
      ...
      },
      {
        ...
        heroBg: 'bg-sky-950',
        heroText: 'text-white',
        heroMutedText: 'text-sky-100',
        heroSurface: 'bg-white/10 border-white/20',
        heroAction: 'bg-white text-sky-950 hover:bg-sky-100',
        heroSecondary: 'bg-white/10 text-white border-white/20 hover:bg-white/20',
