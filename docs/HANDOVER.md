...
- Current Worker deployment: Cloudflare version `c82b9177-49cb-4fc7-b39b-2fe9cde52c52`; HTTP checks for `/`, `/businesses?q=bekary` and `/vendor/the-thornbury-theatre` returned 200 on 29 August 2026. Full in-app-browser visual acceptance remains to be recorded because this task did not expose an in-app-browser control surface.
