...
**Status:** approved delivery plan; implementation has not started.
...
4. Implement the owner-authorised rich-import review, exact-image permission attestation and existing-media-workflow integration.
